            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                {favoriteLists.length > 0 ? (
                      ...
                      >
                        <div className="flex items-center justify-between p-3 rounded-lg border hover:bg-gray-50 transition-colors">
                          ...
                          <div className="flex gap-2">
                            {list.activities &&
                              list.activities.slice(0, 2).map(activity => (
                                <span
                                  key={activity}
                  ...
                  <p className="text-center text-gray-500 py-4">No favorite lists yet</p>
                )}
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                {recentLists.length > 0 ? (
                  ...
                  <p className="text-center text-gray-500 py-4">No lists created yet</p>
                )}
              </div>
            </CardContent>
          </Card>
